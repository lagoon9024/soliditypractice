...
// set the provider you want from Web3.providers
  ...
  web3 = new Web3(new Web3.providers.HttpProvider("http://192.168.0.41:8545"));
...
const smartContract = web3.eth
  .contract(abi)
  .at("0xa05aa3b889e43347dd1f5477b450fab67f6500d9");
...
function show() {
  smartContract.chat().watch((err, res) => {
    if (!err) {
      ...
      div.className = "card";
      const date = new Date(res.args.timeStamp.c[0]);
      const string = `
...
$(function() {
  ...
  $("#button").click(() => {
    console.log("submit");
    if (web3.personal.unlockAccount(web3.eth.defaultAccount, "eth")) {
